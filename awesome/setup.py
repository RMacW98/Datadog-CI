...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'awesome', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-awesome',
    version=ABOUT['__version__'],
    description='The Awesome check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent awesome check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Michael Frey',
    author_email='support.datadog@itunified.de',
    # License
    ...
    packages=['datadog_checks.awesome'],
